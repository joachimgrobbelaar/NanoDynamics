...
def main():
    ap = argparse.ArgumentParser(description="Evaluate PINN vs simulation")
    ap.add_argument("--ckpt", default=os.path.join(AI_DIR, "checkpoints", "pinn.pt"))
    ...
    args = ap.parse_args()
    evaluate(args.ckpt, args.alt_km, args.inc_deg, args.orbits, args.dt)
